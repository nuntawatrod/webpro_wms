// public/js/history.js - Transaction History Log
        ...
        if (total === 0) {
            ...
            pageData.forEach(log => {
                ...
                if (actionType === 'ADD') {
                    ...
                    actionBadge = `<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-amber-100 text-amber-700">ลบสินค้า</span>`;
